...
typedef LabelSetP(*taint2_query_ram_t)(uint64_t pa);
static taint2_query_ram_t __taint2_query_ram = NULL;
static inline LabelSetP taint2_query_ram(uint64_t pa);
static inline LabelSetP taint2_query_ram(uint64_t pa){
...
typedef void(*taint2_labelset_ram_iter_t)(uint64_t pa, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static taint2_labelset_ram_iter_t __taint2_labelset_ram_iter = NULL;
static inline void taint2_labelset_ram_iter(uint64_t pa, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static inline void taint2_labelset_ram_iter(uint64_t pa, int (*app)(uint64_t el, void *stuff1), void *stuff2){
    return __taint2_labelset_ram_iter(pa,app,stuff2);
}
typedef void(*taint2_labelset_reg_iter_t)(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static taint2_labelset_reg_iter_t __taint2_labelset_reg_iter = NULL;
static inline void taint2_labelset_reg_iter(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static inline void taint2_labelset_reg_iter(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2){
    return __taint2_labelset_reg_iter(reg_num,offset,app,stuff2);
}
typedef void(*taint2_labelset_llvm_iter_t)(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static taint2_labelset_llvm_iter_t __taint2_labelset_llvm_iter = NULL;
static inline void taint2_labelset_llvm_iter(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static inline void taint2_labelset_llvm_iter(int reg_num, int offset, int (*app)(uint64_t el, void *stuff1), void *stuff2){
    return __taint2_labelset_llvm_iter(reg_num,offset,app,stuff2);
}
typedef void(*taint2_labelset_iter_t)(LabelSetP ls, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static taint2_labelset_iter_t __taint2_labelset_iter = NULL;
static inline void taint2_labelset_iter(LabelSetP ls, int (*app)(uint64_t el, void *stuff1), void *stuff2);
static inline void taint2_labelset_iter(LabelSetP ls, int (*app)(uint64_t el, void *stuff1), void *stuff2){
    return __taint2_labelset_iter(ls,app,stuff2);
}
typedef uint64_t *(*taint2_labels_applied_t)(void);
static taint2_labels_applied_t __taint2_labels_applied = NULL;
static inline uint64_t * taint2_labels_applied(void);
static inline uint64_t * taint2_labels_applied(void){
