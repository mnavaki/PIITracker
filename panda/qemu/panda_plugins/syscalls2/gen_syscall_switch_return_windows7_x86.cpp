...
#define SERIAL_NO_TAINT_LABEL 1

extern std::ofstream faros_syscall;

extern void syscall_log(const char *msg);
 ...
 */
int AddArgument2(CPUState *env, void *arg1, uint32_t size1, void *arg2, uint32_t size2, uint32_t arg_no, ReturnPoint &rp ){
...
int get_DeviceIoControlFile_info(CPUState *env, taintLocation **taintLocations, uint32_t io_control_code) {

    get_DeviceIoControlFile_out_buffer_32 (env, taintLocations, io_control_code);
    return 1;
}
...
taintLocation *taintLocations = NULL;
get_DeviceIoControlFile_info(env, &taintLocations, arg5);

PPP_RUN_CB(on_NtDeviceIoControlFile_return, env, pc, taintLocations); 
